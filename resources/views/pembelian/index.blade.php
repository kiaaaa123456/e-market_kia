            ...
            <div class="card-body">
                ...
                <form class="" id="formTransaksi" method="POST" action="pembelian">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label for="kode-pembelian" class="col-4 col-form-label col-form-label-sm">Kode
                                Pembelian</label>
                            <div class="col-8">
                                <input type="text" class="form-control form-control-sm" id="kode-pembelian" readonly
                                    value="{{ $kode }}" name="kode_masuk">
                            </div>
                        </div>
                        <div class="col-6">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="date-picker form-control col-md-12 col-xs-12" required="required"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                            <label class=" col-form-label col-md-6 col-sm-6-xs-12">Distributor</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table id="tblTransaksi" class="table table-stripped table-bordered bulk_action">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="6" style="text-align: center;font-style:italic">Belum ada data
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    {{-- bagian total,submiy, data hidden --}}
                    <div class="row justify-content-end" style="text-align: right;">
                        <label class="control-label col-md-2 col-sm-2 offser-md-7">Total Harga</label>
                        <div class="col-md-3 " style="padding-right: 10px;align-content: right;">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-6 col-xs-12"
                            style="text-align: right; margin-right:0;padding-right0;margin-top:20px">
