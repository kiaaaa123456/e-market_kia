...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('bootstrap-5.3.1-dist') }}/css/bootstrap.min.css" rel="stylesheet"
...
<body class="bg-light">
    ...
    <script src="{{ asset('bootstrap-5.3.1-dist') }}/js/bootstrap.bundle.min.js"crossorigin="anonymous">
    </script>
